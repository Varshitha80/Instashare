...
class Updateprofile extends Component {
     state = {userid:'',username:'',userbio:'',errormsg:'',showerror:false,profilepic:''}
      ...
      onsubmitform = async event => {
        ...
        const {username,userbio,userid,profilepic} = this.state
        const userdetails = {user_name:username,user_bio:userbio,user_id:userid,profile_pic:profilepic}
      ...
      render() {
        const {username,userbio,userid,profilepic, showerror, errormsg} = this.state
        const jwttoken = Cookies.get('jwt_token')
        ...
        return (
          <div className="logincon1">
            <form className="logincon2 conheight" onSubmit={this.onsubmitform}>
              ...
              <div className="logincon4">
                <label htmlFor="profilepic" className="loginlabel">
                  PROFILE PIC
                </label>
                <input
                  type="text"
...
export default withNavigate(Updateprofile)